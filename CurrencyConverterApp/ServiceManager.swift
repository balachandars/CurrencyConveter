...
class ServiceManager: NSObject {
    ...
    func createURLRequestForURLWithType(urlString:String,type:String) -> NSMutableURLRequest {
        ...
        let urlRequest: NSMutableURLRequest! = NSMutableURLRequest.init(url: url as URL, cachePolicy: NSURLRequest.CachePolicy.reloadIgnoringCacheData, timeoutInterval: 300)
